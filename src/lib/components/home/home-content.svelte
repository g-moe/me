...
<div class="flex flex-col space-y-24 animate-[boot-in_500ms_ease-out]">
  <section id="about" class="scroll-mt-12">
    <div
      class="mb-8 flex items-end justify-between border-b border-(--glass-edge) pb-3"
    >
      <h2 class="font-display text-3xl font-bold text-neutral-e8">
        <span class="mr-2 text-primary">01.</span>About
      </h2>
    </div>
    <div class="select-none space-y-6 text-base text-neutral-e5">
      <p class="leading-relaxed">
        Hi I'm <span class="font-bold text-mint">Garrett</span>, and programming
        started for me by tinkering on the computer as a kid.
      </p>

      <p class="leading-relaxed">
        Currently, I'm building
        <span class="font-bold text-mint">Tradester </span>, a futures trading
        platform which I help co-found. I enjoy making things
        <span class="font-bold text-mint">look good</span> and
        <span class="font-bold text-mint"> fast</span>
        through multiple iterations. In my free time I
        <span class="font-bold text-mint">build</span> various tools (many
        trading related), and dabble in whatever ignites
        <span class="font-bold text-mint">curiosity</span>.
      </p>
    </div>
  </section>
  ...
  <section id="projects" class="scroll-mt-12">
    ...
    >
      <h2 class="font-display text-3xl font-bold text-neutral-e8">
        <span class="mr-2 text-primary">02.</span>Projects
      </h2>
      <span class="hidden text-xs text-neutral-e4 sm:block">~/projects</span>
    </div>
    <div class="flex flex-col space-y-10">
      <ProjectCard
        ...
        imageUrl="/site.png"
        route="/"
        tags={["Svelte", "Tailwind", "Cloudflare Pages", "Oxlint", "Oxfmt"]}
        title="This Website"
      />
    ...
    <div class="mt-12 text-center">
      <Button
        class="text-sm font-medium text-neutral-e4"
